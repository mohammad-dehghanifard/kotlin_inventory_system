...
class Actions {
    companion object {
        fun addProduct(handler : ProductHandler) {
        ...
        fun increaseProduct(handler: ProductHandler) {
        ...
        fun decreaseProduct(handler: ProductHandler) {
            println("شناسه محصوا را وارد کنید")
            val sku = readln()
            println("تعدادا را وارد کنید")
            val input = readln().toInt()
        ...
        fun deleteProduct(handler: ProductHandler) {
            println("شناسه محصوا را وارد کنید")
            val sku = readln()
